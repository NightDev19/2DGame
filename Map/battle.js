export default function setBattle(worldState) {
  ...
  onKeyPress("space", () => {
    ...
    if (phase === "enemy-turn") {
      ...
      if (damageDealt > 150) content.text = "It's a critical hit!";
    ...
    if (phase === "player-turn") {
      const damageDealt = Math.random() * 230;
      content.text =
        damageDealt > 150 ? "It's a critical hit!" : "MUSHROOM used tackle.";
